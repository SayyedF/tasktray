    ...
    <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
            <div class="card-body">
                ...
                <g:form class="form-signin" action="save" controller="register" method="POST"
                        id="registerForm"
                    ...
                    <div class="form-group">
                        <input type="tel"  placeholder="Phone" class="form-control" name="repassword1" id="repassword1"
                               pattern= "[0-9]{6,10}" title="Phone or Mobile" required/>
                    </div>
                    ...
                    <div class="form-group">
                            <input type="text" class="form-control" name="name" placeholder="City" required/>
                    </div>

                    <div class="form-group">
                            <input type="text" class="form-control" name="name" placeholder="Region / State" required/>
                    </div>

                    <div class="form-group">
                            <input type="text" class="form-control" name="name" placeholder="Postal / Zip code" required/>
                    </div>
...
<script type="text/javascript">
		...
		document.addEventListener("DOMContentLoaded", function(event) {
			document.forms['registerForm'].elements['companyName'].focus();
		});
