...
<html xmlns:g="http://www.w3.org/1999/XSL/Transform">
    ...
    <div class="container">
        ...
        <div class="nav" role="navigation">
            <ul>
                <li><g:link class="task-list" action="alltasks">My Tasks</g:link></li>
        ...
        <div id="show-task" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.task}" controller="lead" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" controller="lead" id="${this.task.id}">
                    ...
                    <g:if test="${mode== 'End'}">
                        <g:link class="taskstop" action="end" controller="lead" id="${this.task.id}"
                                onclick="return confirm('${message(code: 'default.button.delete.confirm.message',
