...
<html xmlns:g="http://www.w3.org/1999/XSL/Transform">
    ...
    <div class="myclass">
        ...
        <div id="show-employee" class="content scaffold-show" role="main">
            ...
            <f:display bean="employee" except="password, enabled, passwordExpired, accountExpired, accountLocked"/>
            <g:form resource="${this.employee}" method="DELETE">
                <fieldset class="buttons">
                   ...
                   <!-- <input class="delete" type="submit" value="${message(code: 'default.button.delete.label', default: 'Delete')}"
                    ...
                    <g:link class="edit" action="changePassword" resource="${this.employee}">Change Password</g:link>
